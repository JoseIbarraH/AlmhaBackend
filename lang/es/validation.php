...
return [
    ...
    'attributes' => [
        ...
        'carouselSetting' => 'carrusel',
        'imageVideoSetting' => 'imagen o video',
        'carousel' => 'imágenes del carrusel',
        'carousel.*.path' => 'imagen del carrusel',
        'carousel.*.title' => 'descripción del carrusel',
        'carousel.*.subtitle' => 'descripción del carrusel',
        'carouselNavbar' => 'imágenes del carrusel del navbar',
        'carouselNavbar.*.path' => 'imágen del carrusel del navbar',
        'carouselNavbar.*.title' => 'titulo de la imágen del carrusel del navbar',
        'carouselNavbar.*.subtitle' => 'subtitulo de la imágen del carrusel del navbar',
        'imageVideo' => 'imagen o video principal',
        'imageVideo.*.path' => 'imagen o video principal',
        'imageVideo.*.title' => 'titulo de imagen o video principal',
        'imageVideo.*.subtitle' => 'subtitulo de imagen o video principal',
        'carouselTool' => 'Imagenes del carrusel de herramietas',
        'carouselTool.*.path' => 'imagen del carrusel de herramientas',
        'carouselTool.*.title' => 'titulo de la imagen del carrusel de herramientas',
        'carouselTool.*.subtitle' => 'subtitulo de la imagen del carrusel de herramientas',

        'results_gallery' => 'galería de resultados',
        'results_gallery.*' => 'imagen de la galería de resultados',
    ],
    /*
    |--------------------------------------------------------------------------
    | Mensajes de validación personalizados para CarouselBackgroundRequest
    |--------------------------------------------------------------------------
    */

    'carousel_required' => 'El campo :attribute es obligatorio.',
    'carousel_boolean' => 'El campo :attribute debe ser verdadero o falso.',

    'imageVideo_required' => 'El campo :attribute es obligatorio.',
    'imageVideo_boolean' => 'El campo :attribute debe ser verdadero o falso.',

    'carouselUrls_array' => 'El campo :attribute debe ser un arreglo válido.',
    'carouselUrls_title_string' => 'El titulo debe ser texto.',
    'carouselUrls_subtitle_string' => 'El subtitulo debe ser texto.',

    'imageVideoUrl_required' => 'El campo :attribute es obligatorio.',
    'imageVideoUrl_string' => 'El campo :attribute debe ser texto o una URL válida.',

    'url_or_text_invalid' => 'El campo :attribute debe ser una URL, texto o archivo válido.',
    'image_or_video_invalid' => 'El campo :attribute debe ser una imagen o video válido.',
    'file_too_large' => 'El archivo :attribute no debe superar los 100MB.',

    /*
    |--------------------------------------------------------------------------
    | Validación personalizada para results_gallery
    |--------------------------------------------------------------------------
    */

    'file_invalid' => 'El archivo en :attribute no es válido.',
    'file_format_invalid' => 'El formato del archivo en :attribute no es válido. Se permiten únicamente imágenes en formato JPG, JPEG, PNG, WEBP, GIF o SVG.',
    'file_too_large_15mb' => 'La imagen en :attribute supera el límite de 15MB.',
    'file_must_be_image_or_string' => 'El campo :attribute debe ser una imagen o una cadena de texto (URL).',
    'image_dimensions_min' => 'La :attribute posee dimensiones menores a las aceptadas.',
    'image_dimensions_max' => 'La :attribute supera las dimensiones maximas permitidas 5000 x 5000'
];
