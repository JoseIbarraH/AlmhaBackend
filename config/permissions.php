...
return [
    ...
    'design' => [
        ...
        'update_carouselImage' => 'update_design',
        'update_backgrounds' => 'update_design',
        'update_carouselNavbar' => 'update_design',
        'update_carouselTool' => 'update_design',
    ],
    'role' => [
        'list_role' => 'view_roles',
        'list_permission' => 'view_roles',
